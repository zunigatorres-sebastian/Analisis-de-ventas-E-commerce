# ANÁLISIS DE VENTAS PARA E-COMMERCE
...
### Limpieza de Datos
- Se modifica la columna **descripción** del archivo **categorías** para mejorar la estructura del texto.
![Limpieza descripción](Screenshots/LimpiezaDatos_descripcion.png)
- Se modifica el tipo de dato en la columna **precio unitario** del archivo **productos** a decimal.
![Limpieza precio unitario](Screenshots/LimpiezaDatos_precio_unitario.png)
...
![DAX Ingresos Totales](Screenshots/DAX-IngresosTotales.png)

- Cantidad Total de Productos Vendidos:

![DAX Cantidad Total](Screenshots/DAX-CantidadTotal.png)

- Ingreso promedio por venta:

![DAX Ingreso Promedio Venta](Screenshots/DAX-IngresoPromedioVenta.png)

- Precio Promedio:

![DAX Precio Promedio](Screenshots/DAX-PrecioPromedio.png)
